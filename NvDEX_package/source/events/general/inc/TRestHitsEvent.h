...
class TRestHitsEvent : public TRestEvent {
   ...
   public:
    ...
    void AddHit(Double_t x, Double_t y, Double_t z, Double_t en, Int_t particle_type = 0, Double_t t = 0, Short_t mod = -1,
                Short_t ch = -1);
    ...
    Int_t Getparticle_type(int n) { return fHits->Getparticle_type(n);}
    ...
    void DrawHistograms(Int_t& column, Double_t pitch = 1, TString histOption = "");
